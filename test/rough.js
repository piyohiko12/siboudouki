...
const CASES = {
  ...
  述語: {
    ...
    effortLearned: '続けることが力になる', effortUse: '後輩に教えるとき', valueFound: '続けること', contributeTo: '地域の人',
    licenses: '英検2級を持っている',
    ...
    gapNow: '海外で働きたい',
    knewBy: 'その他', subReason: 'ものづくりに関わりたいから', attractCards: [{ where: '体験授業', weight: 3, feel: ['わくわくした'],
  ...
  丁寧語: {
    ...
    effortLearned: '手順を守ることが大切です', effortUse: '手順を確認しながら作業する場面', valueFound: '手順を守ることです', contributeTo: '現場の人',
    licenses: '危険物取扱者乙種4類',
    personality: ['責任感が強い'], strengths: [], personalityScene: '締め切りが近いときに',
    gapNow: '品質を高めたいです',
    knewBy: '職場見学', subReason: 'ものづくりに関わりたいから', attractCards: [{ where: '職場見学', weight: 3, feel: ['おどろいた', '自分も見習いたいと思った'],
  ...
  体言止めだけ: {
    ...
    effortLearned: '手伝い', effortUse: '作業', valueFound: 'あいさつ', contributeTo: '職場',
    licenses: '', personality: [], strengths: [],
    knewBy: '求人票', subReason: 'ものづくりに関わりたいから', attractCards: [{ where: '求人票', weight: 2, feel: ['安心した'], what: '休日の多さ', link: '' }],
