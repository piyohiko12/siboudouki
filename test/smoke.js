...
const shingaku = Object.assign({}, common, {
  ...
  efforts: ['課題研究・探究学習', '生徒会'], effort2Action: '行事の企画',
  ...
  strengthScene: 'グループで調べたことをまとめる場面',
  ...
  featureDetail: '自治体と組んだ課題調査', featureSource: '学校案内・パンフレット',
  valueFound: '人と話しながら考えを深めること', contributeTo: '地域の高齢者',
...
const shushoku = Object.assign({}, common, {
  ...
  efforts: ['アルバイト', '部活動'], effort2Action: '1年生への指導',
  ...
  featureDetail: '検査から出荷までの一貫生産', featureSource: '職場見学',
  valueFound: '手順を守って確かめること', contributeTo: '製品を使う人', jobTask: '部品の加工と寸法の確認',
