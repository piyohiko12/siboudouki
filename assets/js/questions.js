  ...
  const PICKER = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: function () { return 'これから伸ばしたい力が、はっきりしている'; },
          note: '伸ばしたい力から書き出す書き方が向いています',
          vote: { gap: 2 }
        },
        {
      ...
      // ─────────────────── その志望先と自分が合っていると思う理由
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'これから伸ばしたい力', required: true,
            only: ['gap'],
            ...
            hint: 'この構成は、ここが出発点になります。「〜する力」の形にすると入れやすいです。'
              + 'できないことを書くのではなく、「これから身につけたいこと」を書きます。',
            preview: function (d) {
              return txt(d.gapNow) ? '私がこれから伸ばしたいのは、' + txt(d.gapNow) + 'です。' : '';
            }
          }
