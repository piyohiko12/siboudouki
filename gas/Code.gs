...
var COLUMNS = [
  ...
  { key: 'grade',            label: '学年',                  width: 70 },
  { key: 'classGroup',       label: 'クラス',                width: 80 },
  { key: 'seatNo',           label: '出席番号',              width: 80 },
  ...
  { key: 'effortWhich',      label: 'どの活動か',            width: 160 },
  ...
  { key: 'personalityEpisode', label: '性格のきっかけ',      width: 200 },
  { key: 'personalityScene', label: '性格を活かせる場面',    width: 200 },
